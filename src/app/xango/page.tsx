...
export default function ItanOgum() {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4">
      <Background />

      <div className="bg-white bg-opacity-90 rounded-2xl shadow-lg p-8 max-w-3xl text-black z-10">
        ...
        <p className="text-2xl mb-4">
          ...
          Era Oyá! Era o amalá do rei que ela preparava!
        </p>
